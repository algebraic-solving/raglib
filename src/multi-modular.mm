...
(**
eqs1 and eqs2 are lists of polynomials
pol is a polynomial
vars is a list of variables (those occurring in these data)

Let I be the ideal generated by eqs1, J the saturation of I by pol and 
K = J + H where H is the ideal generated by pol and eqs2

SaturateIntersect returns a list L of polynomials such that K is
generated by eqs1, L
**)
